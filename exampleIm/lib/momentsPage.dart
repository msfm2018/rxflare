...
class MomentsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final service = RxObjMgr.find<ChatService>();
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    ...
                    child: const Center(child: Text("背景图")),
                  ),
                  Positioned(
                    right: 20,
                    bottom: 10,
                    child: Row(
                      ...
                      children: [
                        const Text(
                          "我的名字",
                          style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold, shadows: [Shadow(blurRadius: 2)]),
                        ),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Text(item["avatar"], style: const TextStyle(color: Colors.white)),
            ),
          ),
          const SizedBox(width: 10),
          // 内容区
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      icon: const Icon(Icons.more_horiz, color: Color(0xFF576B95)),
                      onPressed: () {},
                    ),
                  ],
                ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  item["likes"].join(", "),
                                  style: const TextStyle(color: Color(0xFF576B95), fontWeight: FontWeight.w500),
                                ),
                              ),
                            ],
                          ),
